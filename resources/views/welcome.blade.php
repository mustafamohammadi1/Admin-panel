...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   ================================================== -->
	...
	<meta name="author" content="">
        ...
        <!-- Styles -->
        	<!-- CSS
    ================================================== -->
   <link rel="stylesheet" href="welcome-page/css/default.css">
	<link rel="stylesheet" href="welcome-page/css/layout.css">
   <link rel="stylesheet" href="welcome-page/css/media-queries.css">
   <link rel="stylesheet" href="welcome-page/css/magnific-popup.css">
   ...
   <!-- Favicons
	================================================== -->
	<link rel="shortcut icon" href="welcome-page/favicon.png" >
   ...
   <header id="home">
      ...
      <nav id="nav-wrap">
         ...
         <ul id="nav" class="nav">
            ...
            <li class="smoothscroll" >            @if (Route::has('login'))
      ...
      <div class="row banner">
         <div class="banner-text">
            <h1 class="responsive-headline">Jahan Tech</h1>
            <h3>I'm Mustafa Mohammadi <span>Web Developer</span>, <span>illustrator</span> and <span>webdesigner</span> creating awesome and
         ...
         <div class="nine columns main-col">
            ...
            <div class="row">
               ...
               <div class="columns contact-details">
                  ...
                  <p class="address">
						   <span>Mustafa Mohammadi</span><br>
						   <span>Afganistan, Kabul, Faiz-Mohammad-Katib-Hazara Street<br>
						      
                     </span><br>
						   <span>+93 787365393</span><br>
                     <span>mustafam@aidrivers.io</span>
					   </p>
         ...
         <div class="nine columns main-col">
            ...
            <div class="row item">
               ...
               <div class="twelve columns">
                  ...
                  <p class="info">Bachelor in Information Technology.<span>&bull;</span> <em class="date">April 2016</em></p>
            ...
            <div class="row item">
               ...
               <div class="twelve columns">
                  ...
                  <h3>School of Cool Developer</h3>
                  <p class="info">B.A. Degree in Developer <span>&bull;</span> <em class="date">March 2017</em></p>

                  <p>
                  This is Laravel's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.
         ...
         <div class="nine columns main-col">
            ...
            voluptatem sequi nesciunt.
				...
				<div class="bars">
				   ...
				   <ul class="skills">
					   <li><span class="bar-expand html5"></span><em>Laravel</em></li>
                  <li><span class="bar-expand illustrator"></span><em>Tailwind-CSS</em></li>
      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <ul class="copyright">
               ...
               <li>Design by <a href="http://www.styleshout.com/" title="Styleshout" target="_blank">Mustafa Mohammadi</a></li>   
            </ul>
